...
ByteStreamAddressProviderSvc.TypeNames += [ "xAOD::TriggerTowerContainer_v2/xAODTriggerTowers" ]
ByteStreamAddressProviderSvc.TypeNames += [ "xAOD::TriggerTowerContainer_v2/xAODTriggerTowersSpare" ]
ByteStreamAddressProviderSvc.TypeNames += [ "xAOD::TriggerTowerContainer_v2/xAODTriggerTowersMuon" ]
