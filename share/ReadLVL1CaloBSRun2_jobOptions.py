...
from TrigT1CaloByteStream.TrigT1CaloByteStreamConf import LVL1BS__PpmByteStreamTool2
...
ByteStreamAddressProviderSvc.TypeNames += [ "xAOD::TriggerTowerContainer_v2/TriggerTowers2" ]
