...
ByteStreamAddressProviderSvc.TypeNames += [ "DataVector<xAOD::TriggerTowerContainer_v2>/TriggerTowersSpare" ]
ByteStreamAddressProviderSvc.TypeNames += [ "DataVector<xAOD::TriggerTowerContainer_v2>/TriggerTowersMuon" ]
