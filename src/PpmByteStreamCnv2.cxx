...
#include "PpmByteStreamCnv2.h"
#include "PpmByteStreamTool2.h"

namespace LVL1BS {

PpmByteStreamCnv2::PpmByteStreamCnv2( ISvcLocator* svcloc )
    : Converter( ByteStream_StorageType, classID(), svcloc ),
      m_name("PpmByteStreamCnv2"),
      m_tool("LVL1BS::PpmByteStreamTool2/PpmByteStreamTool2"),
...
PpmByteStreamCnv2::~PpmByteStreamCnv2()
{
}

// CLID

const CLID& PpmByteStreamCnv2::classID()
{
...
StatusCode PpmByteStreamCnv2::initialize()
{
...
StatusCode PpmByteStreamCnv2::createObj( IOpaqueAddress* pAddr,
                                        DataObject*& pObj )
{
...
StatusCode PpmByteStreamCnv2::createRep( DataObject* pObj,
