#ifndef TRIGT1CALOBYTESTREAM_PPMCRATEMAPPINGTOOL_H
#define TRIGT1CALOBYTESTREAM_PPMCRATEMAPPINGTOOL_H
...
class PpmCrateMappingTool : virtual public IPpmCrateMappingTool,
                                    public AlgTool {

 public:

   PpmCrateMappingTool(const std::string& type, const std::string& name,
                                                const IInterface* parent);
   virtual ~PpmCrateMappingTool();
